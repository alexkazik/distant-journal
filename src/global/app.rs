...
use crate::pane::todo_complete::{MsgTodoComplete, PaneTodoComplete};
...
pub(crate) enum MsgApp {
    MsgTodo(MsgTodo),
    MsgTodoComplete(MsgTodoComplete),
    MsgMap(MsgMap),
...
pub(crate) struct App {
    ...
    pub(crate) pane_todo_complete: PaneTodoComplete,
...
impl App {
    const STORAGE_KEY_GAME_DATA: &'static str = "distant-skies-journal.game-data";
    const STORAGE_KEY_SETTINGS: &'static str = "distant-skies-journal.settings";
}
...
impl Component for App {
    ...
    fn create(ctx: &Context<Self>) -> Self {
        ...
        let mut result = Self {
            ...
            pane_todo_complete: PaneTodoComplete::create(ctx),
        ...
        if let Ok(game_data) = LocalStorage::get::<SerdeGameData2>(Self::STORAGE_KEY_GAME_DATA) {
        ...
        while let Some(msg) = self.data.chain_msg.pop_front() {
            r |= match msg {
                ...
                MsgApp::MsgTodoComplete(msg) => {
                    self.pane_todo_complete.update(&mut self.data, ctx, msg)
                }
                ...
                MsgApp::HistoryChanged => {
                    match self.router.current_route(&self.data) {
                        Some(route) => {
                            ...
                            match route {
                                Route::Todo | Route::TodoAction(_, _) | Route::TodoComplete(_) => {
                                    self.quests_is_map = false;
                                }
                                Route::Map
                                | Route::MapLocation(_)
                                | Route::MapAction(_, _)
                            ...
                            match route {
                                ...
                                Route::TodoComplete(q) => {
                                    if self.pane_todo_complete.go(&self.data, q) {
                                        UpdateResult::Render.into()
                                    } else {
                                        // not valid -> "redirect" to start page
                                        self.router.go_replace(&self.data, Route::Todo);
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        let inner = match self.route {
            ...
            Route::TodoComplete(_) => self.pane_todo_complete.view(&self.data, ctx),
            ...
            <nav class="navbar sticky-top bg-body-tertiary">
              <div class="container-fluid">
                <a class="navbar-brand" href="#">
                  {"Unofficial Distant Skies Journal"}
                </a>
            ...
            <nav class="navbar sticky-bottom bg-body-tertiary">
              <div class="container-fluid">
                ...
                <div class="ms-auto">
                  ...
                  <a
                    href="https://github.com/alexkazik/distant-journal"
                    target="_blank"
